...
const T = {
  ...
  en: {
    ...
    'brewers.1.bio':          'Anton has 5+ years in beer brewing. As head brewer, he coordinates brewing, keeps track of the fermentation process and logistics. He does not hesitate to experiment because in the end it all becomes beer anyway.',
    'brewers.2.name':         'Anna Lindqvist',
  ...
  de: {
    ...
    'brewers.1.bio':          'Anton hat 5+ Jahre Erfahrung im Bierbrauen. Als Chefbrauer koordiniert er das Brauen, beaufsichtigt den Gärprozess und die allgemeine Logistik Er zögert nicht zu experimentieren, denn am Ende wird es sowieso Bier.',
    'brewers.2.name':         'Anna Lindqvist',
